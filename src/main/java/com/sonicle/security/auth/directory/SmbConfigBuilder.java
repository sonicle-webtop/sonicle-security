 ...
 * @author malbinola
 */
public class SmbConfigBuilder extends AbstractConfigBuilder {
	private static final SmbConfigBuilder BUILDER = new SmbConfigBuilder();
	protected static final String PARAM_HOST = "host";
	protected static final String PARAM_PORT = "port";
	
	public static SmbConfigBuilder getInstance() {
		return BUILDER;
	}
